...
\begin{figure}[ht]
    ...
    \caption{Average spectrum for the \textit{tumor} label. The shaded band shows $\pm1$ standard deviation across spectra. The \textit{fingerprint region} and \textit{CH region} are joined at band n.382, where the intensity is 0.}
...
The \textit{tumor} macro-class includes the \textit{tumor (2)} and \textit{tumor with necrosis (20)} , since necrotic tissue is expected to be adjacent to tumors and, being mixed with tumor, not to affect affect the average spectrum noticeably (pure \textit{necrosis (0)} was previously deleted from the dataset);
