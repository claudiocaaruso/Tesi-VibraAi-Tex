...
\Cref{fig:pca_score_.pc1_pc483} highlights the large difference in the distribution of data along the first and last components calculated by PCA. The cloud is particularly wide along the first component and compressed almost to zero along PC483, with few exceptions with respect to the number of data. 
