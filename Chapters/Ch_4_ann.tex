...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{Images/images_ch_4/sigmoid.png}
...
The \textit{Rectified Linear Unit} (ReLU) is a simpler alternative that has become the default choice in deep networks:
