...
\begin{enumerate}
    \item The dataset is divided by Sample ID into $k$ stratified folds (\textit{Stratified Group K-Fold}), keeping the ratio of the two labels close to 1:1 in each fold and ensuring that no Sample ID is split across folds.
