...
The metrics analyzed in order to make this assessment are the \textit{Explained Variance Ratio} (EVR), which is the variance fraction explained by each \(\mathrm{PC}_j\) component, strictly linked to the singular values
