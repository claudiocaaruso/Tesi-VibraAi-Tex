...
This learning method, solely based on the prediction for one instance, cannot be applied in networks with more than one hidden layer. This is due to not being able to isolate the role of a single connection in the prediction. The method, as can be seen from the structure of \cref{eq:perceptron_update}, strongly resembles gradient descent.
