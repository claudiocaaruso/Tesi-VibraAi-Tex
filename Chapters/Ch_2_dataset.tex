...
All classes appear to have the same trends, with multiple similar peaks in the 'fingerprint region' (500-1800 $cm^{-1}$) and a major peak in the 'CH region' (2800-3500 $cm^{-1}$). The only exceptions are represented by \textit{unlabeled/transparent}, \textit{artifact} and \textit{necrosis} pixels, which noticeably differed from all others (Fig.\ref{fig:spectra_comparison_discarded})
