...
This chapter describes the dataset of Raman spectra collected from head and neck squamous cell carcinoma (HNSCC) tissue samples. It gives an overview on the organisation of the dataset, the histopathological labels and their limitations, the spectral preprocessing already applied before delivery, and the binary labeling strategies used for classification.
