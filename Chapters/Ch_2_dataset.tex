...
In a preliminary visual analysis the average spectrum for each class has been computed. Individual spectra can have a relative deviation of  up to 50\% of the peak value in low intensity regions,min decreasing to roughly 20\% for major peaks.
