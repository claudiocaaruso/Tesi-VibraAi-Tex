...
The dataset described in \Cref{sec:origin-structure} was stored as a single \texttt{.parquet} file. \Cref{tab:dataset-columns} details the exact column layout of that file, as used by the data-loading code.
